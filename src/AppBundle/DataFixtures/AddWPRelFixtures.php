...
class AddWPRelFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        //Create these users for the functional tests

        if (empty($manager->getRepository(User::class)->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC7'))))
        {
            $user1 = new User();
            $user1->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPRC7');
            $user1->setFirstName('User');
            $user1->setLastName('One');
            $user1->setEmail('WPRelationship@userone.com');
            ...
            $user2 = new User();
            $user2->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPRC6');
            $user2->setFirstName('User');
            $user2->setLastName('Two');
            $user2->setEmail('WPRelationship@usertwo.com');
            ...
            $user3 = new User();
            $user3->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPRC8');
            $user3->setFirstName('User');
            $user3->setLastName('Three');
            $user3->setEmail('WPRelationship@userthree.com');
            ...
            $user4 = new User();
            $user4->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPRC9');
            $user4->setFirstName('User');
            $user4->setLastName('Four');
            $user4->setEmail('WPRelationship@userfour.com');
            ...
            $user5 = new User();
            $user5->setUserId('2FAC2763-9FC0-FC21-4762-42330CAWPRC5');
            $user5->setFirstName('User');
            $user5->setLastName('Three');
            $user5->setEmail('WPRelationship@userfive.com');
    ...
    {
        if (empty($manager->getRepository(User::class)->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPR01'))))
        {
            $user1 = new User();
            $user1->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR01');
            ...
            $user2 = new User();
            $user2->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR02');
            ...
            $user3 = new User();
            $user3->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR03');
            ...
            $user4 = new User();
            $user4->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR04');
            ...
            $user5 = new User();
            $user5->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR05');
            ...
            $user6 = new User();
            $user6->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR06');
            ...
            $user7 = new User();
            $user7->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR07');
            ...
            $user8 = new User();
            $user8->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR08');
            ...
            $user9 = new User();
            $user9->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR09');
            ...
            $user10 = new User();
            $user10->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR10');
            ...
            $user11 = new User();
            $user11->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR11');
            ...
            $user12 = new User();
            $user12->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR12');
            ...
            $user13 = new User();
            $user13->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR13');
            ...
            $user14 = new User();
            $user14->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR14');
            ...
            $user15 = new User();
            $user15->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR15');
            ...
            $user16 = new User();
            $user16->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR16');
    ...
    public function addPatientRel(ObjectManager $manager)
    {
        ...
        //implemened)
        $user17 = new User();
        $user17->setUserId('1FAC2763-9FC0-FC21-4762-42330CAWPR17');
        ...
        #region Patients
        $patient1 = new User();
        $patient1->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR01');
        $patient1->setFirstName('User');
        $patient1->setLastName('One');
        $patient1->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient2 = new User();
        $patient2->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR02');
        $patient2->setFirstName('User');
        $patient2->setLastName('One');
        $patient2->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient3 = new User();
        $patient3->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR03');
        $patient3->setFirstName('User');
        $patient3->setLastName('One');
        $patient3->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient4 = new User();
        $patient4->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR04');
        $patient4->setFirstName('User');
        $patient4->setLastName('One');
        $patient4->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient5 = new User();
        $patient5->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR05');
        $patient5->setFirstName('User');
        $patient5->setLastName('One');
        $patient5->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient6 = new User();
        $patient6->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR06');
        $patient6->setFirstName('User');
        $patient6->setLastName('One');
        $patient6->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient7 = new User();
        $patient7->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR07');
        $patient7->setFirstName('User');
        $patient7->setLastName('One');
        $patient7->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient8 = new User();
        $patient8->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR08');
        $patient8->setFirstName('User');
        $patient8->setLastName('One');
        $patient8->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient9 = new User();
        $patient9->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR09');
        $patient9->setFirstName('User');
        $patient9->setLastName('One');
        $patient9->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        $patient10 = new User();
        $patient10->setUserId('1FAC2763-9FC0-FC21-4762-42330CPWPR00');
        $patient10->setFirstName('User');
        $patient10->setLastName('One');
        $patient10->setEmail('cst.project5.refresh+'.uniqid(). '@gmail.com');
        ...
        for ($i = 0; $i < 10; $i++)
        {
            $patient = $manager
                  ->getRepository(User::class)
                  ->findOneBy(['userID' => '1FAC2763-9FC0-FC21-4762-42330CPWPR0'.$i]);
    ...
    public function loadClients(ObjectManager $manager)
    {
        ...
        $loginUser1->setPassword('$2y$13$ouajAK4OsUqSl47uaz0nwOVDPeQNskHOne8e9Jo.oZfS/4ff1D8.e');
    ...
    public function unloadWP(ObjectManager $manager)
    {
        for ($i = 1; $i <= 16; $i++)
        {
            $wp = $manager->getRepository(WellnessProfessional::class)->findOneBy(array('user' => '1FAC2763-9FC0-FC21-4762-42330CAWPR' . ($i < 10 ? '0' : '') . $i ));
    ...
    public function unload(ObjectManager $manager)
    {
        $user1 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC7'));
        ...
        $user2 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC6'));
        ...
        $resp1 = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC6'));
        ...
        $user3 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC8'));
        ...
        $user4 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC9'));
        ...
        $relationship = $manager->getRepository(Relationship::class)
            ->findOneBy(array('relationshipId' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC6:1FAC2763-9FC0-FC21-4762-42330CAWPRC7:wellnessprofessional'));
        ...
        //Remove relationship
        $relationship = $manager->getRepository(Relationship::class)
            ->findOneBy(array('relationshipId' => '1FAC2763-9FC0-FC21-4762-42330CAWPRC7:1FAC2763-9FC0-FC21-4762-42330CAWPRC6:supporter'));
        if(!empty($relationship))
        {
            $manager->remove($relationship);
        }
        ...
        $respondentOne = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '2FAC2763-9FC0-FC21-4762-42330CAWPRC6'));
        ...
        $respondentTwo = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '2FAC2763-9FC0-FC21-4762-42330CAWPRC5'));
        ...
        $wp = $manager->getRepository(WellnessProfessional::class)
            ->findOneBy(array('user'=>'1FAC2763-9FC0-FC21-4762-42330CAWPRC7'));
        ...
        //Remove user1
        $user1 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CAWPRC7'));
        ...
        //Remove user2
        $user2 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CAWPRC6'));
        ...
        //Remove user3
        $user3 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CAWPRC5'));
