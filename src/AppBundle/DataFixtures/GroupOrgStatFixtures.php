...
class GroupOrgStatFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        //Create these users for the functional tests

        if (empty($manager->getRepository(User::class)->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEB9GO6'))))
        {


            $user2 = new User();
            $user2->setUserId('1FAC2763-9FC0-FC21-4762-42330CEB9GO6');
            $user2->setFirstName('User');
            $user2->setLastName('Two');
            $user2->setEmail('grouporgcontrollertest@yahoo.ca');
    ...
    public function unload(ObjectManager $manager)
    {
        ...
        $user2 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEB9GO6'));
        ...
        $resp1 = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '1FAC2763-9FC0-FC21-4762-42330CEB9GO6'));
