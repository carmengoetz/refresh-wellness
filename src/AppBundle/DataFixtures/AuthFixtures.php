...
class AuthFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        if (empty($manager->getRepository(User::class)->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBACC7'))))
        {
            $user1 = new User();
            $user1->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBACC7');
            $user1->setFirstName('User');
            $user1->setLastName('One');
            $user1->setEmail('authenticationController@userone.com');
            ...
            $user2 = new User();
            $user2->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBACC6');
            $user2->setFirstName('User');
            $user2->setLastName('Two');
            $user2->setEmail('authenticationController@usertwo.com');
    ...
    {
        if (empty($manager->getRepository(User::class)->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBAC01'))))
        {
            $user1 = new User();
            $user1->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC01');
            ...
            $user2 = new User();
            $user2->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC02');
            ...
            $user3 = new User();
            $user3->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC03');
            ...
            $user4 = new User();
            $user4->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC04');
            ...
            $user5 = new User();
            $user5->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC05');
            ...
            $user6 = new User();
            $user6->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC06');
            ...
            $user7 = new User();
            $user7->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC07');
            ...
            $user8 = new User();
            $user8->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC08');
            ...
            $user9 = new User();
            $user9->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC09');
            ...
            $user10 = new User();
            $user10->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC10');
            ...
            $user11 = new User();
            $user11->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC11');
            ...
            $user12 = new User();
            $user12->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC12');
            ...
            $user13 = new User();
            $user13->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC13');
            ...
            $user14 = new User();
            $user14->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC14');
            ...
            $user15 = new User();
            $user15->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC15');
            ...
            $user16 = new User();
            $user16->setUserId('1FAC2763-9FC0-FC21-4762-42330CEBAC16');
    ...
    public function unloadWP(ObjectManager $manager)
    {
        for ($i = 1; $i <= 16; $i++)
        {
            $wp = $manager->getRepository(WellnessProfessional::class)->findOneBy(array('user' => '1FAC2763-9FC0-FC21-4762-42330CEBAC' . ($i < 10 ? '0' : '') . $i ));
    ...
    public function unload(ObjectManager $manager)
    {
        $user1 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBACC7'));
        ...
        $user2 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBACC6'));
        ...
        $resp1 = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '1FAC2763-9FC0-FC21-4762-42330CEBACC6'));
        ...
        $user3 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBACC8'));
        ...
        $user4 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '1FAC2763-9FC0-FC21-4762-42330CEBACC9'));
        ...
        $relationship = $manager->getRepository(Relationship::class)
            ->findOneBy(array('relationshipId' => '1FAC2763-9FC0-FC21-4762-42330CEBACC6:1FAC2763-9FC0-FC21-4762-42330CEBACC7:wellnessprofessional'));
        ...
        //Remove relationship
        $relationship = $manager->getRepository(Relationship::class)
            ->findOneBy(array('relationshipId' => '1FAC2763-9FC0-FC21-4762-42330CEBACC7:1FAC2763-9FC0-FC21-4762-42330CEBACC6:support'));
        if(!empty($relationship))
        {
            $manager->remove($relationship);
        }
        ...
        $respondentOne = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '2FAC2763-9FC0-FC21-4762-42330CEBACC6'));
        ...
        $respondentTwo = $manager->getRepository(Respondent::class)
            ->findOneBy(array('user' => '2FAC2763-9FC0-FC21-4762-42330CEBACC5'));
        ...
        $wp = $manager->getRepository(WellnessProfessional::class)
            ->findOneBy(array('user'=>'1FAC2763-9FC0-FC21-4762-42330CEBACC7'));
        ...
        //Remove user1
        $user1 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CEBACC7'));
        ...
        //Remove user2
        $user2 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CEBACC6'));
        ...
        //Remove user3
        $user3 = $manager->getRepository(User::class)
            ->findOneBy(array('userID' => '2FAC2763-9FC0-FC21-4762-42330CEBACC5'));
